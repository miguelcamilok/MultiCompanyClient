...
export default defineComponent({
  ...
  setup() {
    ...
    const categoriesMap: Record<string, string> = {
      ...
      'Tablets Móviles': 'mobile_tablets',
      'Accesorios Móviles': 'mobile_accessories'
    };
    ...
    const filterGroups = [
      ...
      { title: 'Marca', key: 'brand', options: ['Apple', 'Samsung', 'Xiaomi', 'Huawei', 'Motorola', 'OnePlus', 'Sony', 'Lenovo', 'Logitech'] },
    ...
    const breadcrumbs = computed(() => {
      ...
      if (filters.value.category && validCategories.includes(filters.value.category)) {
        crumbs.push({ text: filters.value.category, link: `/mobile?category=${encodeURIComponent(filters.value.category)}` });
      }
      return crumbs;
    });
    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        if (filters.value.category && validCategories.includes(filters.value.category)) {
          ...
          params.category = 'smartphones,cellphones,mobile_tablets,mobile_accessories';
        }
