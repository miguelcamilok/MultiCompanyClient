...
export default defineComponent({
  ...
  setup() {
    ...
    const categoriesMap: Record<string, string> = {
      'Drones Recreativos': 'recreational_drones',
      'Drones Profesionales': 'professional_drones',
      'Accesorios de Drones': 'drone_accessories',
      'Cámaras DSLR': 'dslr_cameras',
      'Cámaras Sin Espejo': 'mirrorless_cameras',
      'Cámaras Deportivas': 'action_cameras',
      'Accesorios de Cámaras': 'camera_accessories'
    };
    ...
    const filterGroups = [
      ...
      { title: 'Marca', key: 'brand', options: ['DJI', 'Parrot', 'Autel', 'GoPro', 'Holy Stone', 'Canon', 'Nikon', 'Sony', 'Fujifilm', 'Panasonic', 'Olympus'] },
    ...
    const breadcrumbs = computed(() => {
      const crumbs = [
        { text: 'Inicio', link: '/' },
        { text: 'Drones y Cámaras', link: '/drones-cameras' }
      ];
      if (filters.value.category && validCategories.includes(filters.value.category)) {
        crumbs.push({ text: filters.value.category, link: `/drones-cameras?category=${encodeURIComponent(filters.value.category)}` });
      }
      return crumbs;
    });
    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        if (filters.value.category && validCategories.includes(filters.value.category)) {
          ...
          params.category = 'recreational_drones,professional_drones,drone_accessories,dslr_cameras,mirrorless_cameras,action_cameras,camera_accessories';
        }
